    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: GestureDetector(
          ...
          child: InkWell(
            onTap: () async {
              final intervalsCreateData = createIntervalsRecordData();
              var intervalsRecordReference = IntervalsRecord.collection.doc();
              await intervalsRecordReference.set(intervalsCreateData);
              bla = IntervalsRecord.getDocumentFromData(
                  intervalsCreateData, intervalsRecordReference);
